...
- **API cross-links**: When mentioning yohou_nixtla classes or functions in markdown cells, wrap them in backtick-link syntax pointing to the API page (e.g., `` [`SeasonalNaive`](/pages/api/generated/yohou_nixtla.point.naive.SeasonalNaive/) ``).
