...
class TestTransformerIntegration:
    ...
    def test_clone_preserves_transformers(self, fast_forecaster_cls):
        ...
        ft = FunctionTransformer()
        forecaster = _make_forecaster(fast_forecaster_cls, actual_transformer=ft)
        cloned = clone(forecaster)
    ...
    def test_actual_transformer_no_X_raises(self, fast_forecaster_cls, daily_y_X_factory):
    ...
    def test_target_as_feature_with_actual_transformer(self, fast_forecaster_cls, daily_y_X_factory):
