...
![Yohou-Nixtla Screenshot](https://raw.githubusercontent.com/stateful-y/yohou-nixtla/main/docs/assets/screenshot_dark.png)

[Optional: Add version compatibility note]
<!-- Example: Currently, Yohou-Nixtla supports Python 3.11+, and [dependency] versions X.Y.z -->
